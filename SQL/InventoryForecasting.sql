SELECT DT.DATE_VALUE,
	   DT.CALENDAR_QUARTER,
	   DT.MONTH_NUMBER_IN_CALENDAR_YEAR AS CALENDAR_MONTH,
	   DT.DAY_NUMBER_IN_WEEK AS DAYINWEEK,
	   HOLS.PRIOR_HOLIDAY AS HOL14DAYPRE,
	   CONSENT.UMCSENT,
	   ST.STORE_NUMBER,
...
WHERE ST.CHANNEL_GROUP = 'RETAIL'
	...
	AND PD.SKU_DISPLAY_NUMBER = '876269'
	AND ST.STORE_NUMBER IN ('001')
GROUP BY DT.DATE_VALUE, DT.CALENDAR_QUARTER, DT.MONTH_NUMBER_IN_CALENDAR_YEAR, DT.DAY_NUMBER_IN_WEEK, HOLS.PRIOR_HOLIDAY, CONSENT.UMCSENT, ST.STORE_NUMBER, PD.SKU_DISPLAY_NUMBER
